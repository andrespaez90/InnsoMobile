...
public class CompanyFragment extends BaseFragment {
    ...
    private void initView() {
        binding.textViewCompanyName.setText(StringUtils.setSpannablesFromRegex(getString(R.string.copy_company_name),
                "^(.*?)\\n", new StyleSpan(Typeface.BOLD), new RelativeSizeSpan(1.2f)));
        binding.textViewCompanyNit.setText(StringUtils.setSpannablesFromRegex(getString(R.string.copy_company_nit), "(.*):", new StyleSpan(Typeface.BOLD)));
    }
}
